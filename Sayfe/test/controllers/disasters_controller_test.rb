...
class DisastersControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create disaster" do
    assert_difference('Disaster.count') do
      post disasters_url, params: { disaster: { desc: @disaster.desc, title: @disaster.title } }
    end
  ...
  test "should update disaster" do
    patch disaster_url(@disaster), params: { disaster: { desc: @disaster.desc, title: @disaster.title } }
